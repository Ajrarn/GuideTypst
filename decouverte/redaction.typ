...
==== Sans numérotation ou listes à puces
...
#warning[Où poser des labels ?][On ne peut poser des labels que sur des éléments numérotés comme les titre des chapitres, section, figures, etc.]

#feature[Ordre des labels et référence][l'ordre dans lequel apparaît le label et la référence n'a aucune importance. Quand il compile le document, il travaille d'abord sur les labels, leur attribue un numéro à chacun et calcule les pages où il devraient se trouver, ensuite il traite les références.]

#feature[Chapitre 2.5, page ci-contre][Je préfère vous prévenir, par défaut la référence ne s'affiche pas comme ça, il n'y a que _Chapitre 2.5_, mais j'ai personnalisé l'affichage pour ajouter la page. Je vous expliquerai comment plus loin.]
